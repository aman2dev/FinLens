  ...
  return (
    <div className="flex min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between border-r border-border/40 bg-card/20 p-12 lg:flex backdrop-blur-3xl">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.1),transparent_50%)]" />
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <span>High-Definition Clarity</span>
          </motion.div>
          <motion.h1 
          ...
          >
            Stop <span className="text-muted-foreground/30 italic">Counting.</span> <br />
          ...
          >
            The premiere architecture for your personal economy. Experience financial command with zero friction.
          </motion.p>
        </div>
